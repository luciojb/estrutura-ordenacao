...
import sorts.InsertionSortFuncionario;

public class ExecutaFuncionarioInsertion {

	public static void main(String[] args) {
		InsertionSortFuncionario insert = new InsertionSortFuncionario();
		...
		Funcionario[] fncsCres = insert.ordenarCrescente(fncs);
		...
		Funcionario[] fncsDec = insert.ordenarDecrescente(fncs);
		...
		Funcionario[] fncsAlf = insert.ordenarOrdemAlfabetica(fncs);
